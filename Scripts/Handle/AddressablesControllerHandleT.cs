...
namespace Kogane
{
	...
	/// </summary>
	public sealed class AddressablesControllerHandle<T> : IAddressablesControllerHandle
	{
		//================================================================================
		// 変数(readonly)
		//================================================================================
		...
		private readonly Task<(T, AddressablesControllerResultCode)> m_task;
		...
		/// リザルトを返します
		/// </summary>
		public T Result => m_task.Result.Item1;

		/// <summary>
		/// リザルトコードを返します
		/// </summary>
		public AddressablesControllerResultCode ResultCode => m_task.Result.Item2;
		...
		(
			...
			Task<(T, AddressablesControllerResultCode)> task
		)
		{
			m_isValid = true;
			m_handle  = handle;
		...
		/// </summary>
		public AddressablesControllerHandle( Task<(T, AddressablesControllerResultCode)> task )
		{
			m_task = task;
		}
	}
